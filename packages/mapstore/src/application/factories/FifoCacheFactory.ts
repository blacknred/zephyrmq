import type { ICacheFactory } from "@app/interfaces/ICacheFactory";
import type { IMemoryCapacityService } from "@zephyrmq/mapstore/src/domain/interfaces/IMemoryCapacityService";
